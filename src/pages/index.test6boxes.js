          ...
          <div key={ideaIndex} className="mb-6 border border-green-500 p-4">
            ...
            <div className="mt-4 text-green-500 text-sm">
              <div className="flex items-center gap-4">
                ...
                <button 
                  onClick={async () => {
                    console.log("Button clicked for idea:", idea); // Debug log clicked idea
                    try {
                      const result = await checkLiteratureNovelty(idea.Experiment);
                      console.log("Got novelty result:", result); // Debug log API result
                      
                      if (result) {
                        setResearchIdeas(prevIdeas => {
                          console.log("Previous ideas:", prevIdeas); // Debug log state update
                          ...
                          console.log("Updated idea:", updatedIdea); // Debug log updated idea
                          
                          updatedGroup.ideas = group.ideas.map(i => 
                            i === idea ? updatedIdea : i
                          );
                          newIdeas[groupIndex] = updatedGroup;
                          console.log("New ideas state:", newIdeas); // Debug log new state
                          return newIdeas;
                        });
                      }
                    } catch (error) {
    ...
    <div className="min-h-screen bg-white">
      <div style={{ 
        ...
        <div className="pt-16 p-8">
          <h1 className="text-4xl mb-8">Jeanne.</h1>
